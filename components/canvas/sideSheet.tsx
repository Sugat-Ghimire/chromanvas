...
export default function UtilitySidebar({
  ...
  return (
    <Sheet>
      <SheetTrigger>
        <AlignJustify className="w-6 h-6 cursor-pointer hover:text-blue-500 transition-colors duration-200" />
      </SheetTrigger>
      <SheetContent className="w-[192px] sm:w-[240px] p-4 bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
        <SheetHeader>
          <SheetTitle className="text-lg font-bold text-center mb-4 bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">
            App Utilities
          </SheetTitle>
        </SheetHeader>
